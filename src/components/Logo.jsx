...
const Logo = ({ className = "", theme = "light", size = "md", showText = true }) => {
  ...
  return (
    <div className={`flex items-center space-x-3 ${className}`}>
      <div className={`${iconSize} flex items-center justify-center bg-lime-500/10
       rounded-xl p-1.1 border border-lime-500/20 shadow-lg shadow-lime-500/5`}>
        <img
          src={logoUrl}
          alt="Meu Pila Logo"
      ...
      {showText && (
        <span className={`${textSize} font-bold tracking-tight ${theme === 'dark'
